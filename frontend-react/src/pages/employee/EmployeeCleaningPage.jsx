...
import { getDatasetPreview, transformDataset, finalizeDataset, revertDataset, pauseCleaning, downloadDataset } from '../../services/api';
...
const EmployeeCleaningPage = () => {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      setError('Failed to download cleaned CSV.');
    }
  };
